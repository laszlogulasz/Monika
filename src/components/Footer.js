...
const Footer = ({...props}) => {
  ...
  const note = props.langState ? "assets/files/bio-eng.pdf" : "assets/files/bio-pl.pdf";
      ...
      <div className="footer--container">
            ...
            <article className="article--center">
              ...
              <a
                ...
                <span style={{paddingLeft: '10px'}}>
                  <strong>{props.langState ? 'DOWNLOAD NOTE' : 'POBIERZ NOTATKĘ'}</strong>
                  </span> (pdf)
              </a>
              <a
                ...
                <span style={{paddingLeft: '10px'}}>
                  <strong>{props.langState ? 'DOWNLOAD PICTURES' : 'POBIERZ ZDJĘCIA'}
                  </strong>
                </span>
          ...
          <section className="contact" id="contact">
            <article className="article--center">
              ...
              <p style={{paddingTop: '0.5em', textAlign: 'center', fontSize: '1.5em'}}>
                AGATA BORZYM
              </p>
              <p>
                <span className="icon">
                  <i className="fas fa-mobile-alt fa-2x" aria-hidden="true"></i>
                </span>
                  mobile:
                    <a
              ...
              <p>
                <span className="icon">
                  <i className="fas fa-at fa-2x" aria-hidden="true"></i>
                </span>MAIL:
                <a
