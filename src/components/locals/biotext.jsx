...
const biopl =<React.Fragment>
  <p>Charyzmatyczna wokalistka urodzona w Warszawie w 1990r. Wydała cztery solowe płyty.</p>
   <p>Szkołę muzyczną w klasie fortepianu ukończyła z wyróżnieniem, następnie rozpoczęła naukę wokalistyki jazzowej w słynnej szkole przy ul. Bednarskiej w Warszawie. Podróż za ocean i nauka w John Hersey High School potwierdziła, że jej drogą jest śpiewanie jazzu. Za namową przyjaciół i nauczycieli brała udział w wielu festiwalach i konkursach, zdobywając nagrody i ważne doświadczenia zawodowe.</p>
   <p>Przełomowym momentem w jej edukacji było otrzymanie stypendium w University of Miami Frost School of Music w 2008 roku. Dwa lata później otrzymała kolejne stypendium w LA Music Academy, gdzie studiowała pod okiem wybitnych artystów jak Tierney Sutton (8 nominacji do Grammy) i Dorian Holley (Michael Jackson, The Tonight Show).</p>
   <p>Jej muzyczna kariera rozpoczęła się od występu w Sali Kongresowej na festiwalu Jazz Jamboree w 2009 roku, gdzie została zaproszona przez Michała Urbaniaka. Miała wtedy 19 lat. Jej brawurowy występ porwał publiczność, wtedy też zaproponowano jej pierwszy kontrakt płytowy (Sony Music).</p>
   <p>Monika jest otwarta na różne gatunki muzyczne. Często występuje gościnnie z różnymi artystami. Śpiewała na kilku płytach Tego Typa Mesa, zaśpiewała na płycie „Wasowski odnaleziony” pod kierownictwem muzycznym K. Herdzina. Bierze udział w projekcie Albo Inaczej wytwórni Alkopoligamia. Pisze piosenki dla innych artystów.</p>
   <p>Studiuje psychoseksuologię, co obok muzyki stało się jej ogromną pasją i życiowym wyzwaniem.</p>
...
const bioen = <React.Fragment>
<p>This incredibly charismatic vocalist with an absolutely unique voice has released already four albums, first two recorded in USA and highly appreciated by Polish audience – platinum record for  <strong>„Girl Talk”</strong> (2011) and for <strong>„My Place”</strong> (2013).</p>
...
<p>She studies psychosexology which next to music has become her passion and a life challenge.</p>
<p>She just released her new concert project singing pieces by her favorite band Radiohead arranged by widely awarded Polish composer/arranger/pianist Nikola Kołodziejczyk. Its unique instrumentation consisting of 3 french horns, bass clarinet, viola da gamba and improvising jazz Trio Stryjo brought her large interest resulting in selling two full houses on the first show. The concert album is coming soon.</p>
</React.Fragment>;
